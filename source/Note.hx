...
class Note extends FlxSprite
{
	...
	private var CharactersWith3D:Array<String> = ["dave-angey", "bambi-3d", 'bambi-unfair', 'exbungo', 'expunged', 'expunged-mad', 'pink-expunged', 'pink-expunged-mad', 'dave-festival-3d', 'dave-3d-recursed', 'bf-3d', 'nofriend'];
